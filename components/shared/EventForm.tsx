                ...
                <FormItem className='w-full '>
                  <FormControl>
                    <div className='flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2'>
                      <Image src={locationLogo} alt="location logo" width={24} height={24}/>
          ...
          <FormField
              ...
              render={({ field }) => (
                <FormItem className='w-full '>
                  <FormControl>
                    <div className='flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2'>
                      <Image src={calendarLogo} alt="calendar logo" width={24} height={24} className='filter-grey'/>
          ...
          <FormField
              ...
              render={({ field }) => (
                <FormItem className='w-full '>
                  <FormControl>
                    <div className='flex-center h-[55px] w-full overflow-hidden rounded-full bg-grey-50 px-4 py-2'>
                      <Image src={dollar} alt="dollar logo" width={24} height={24} className='filter-grey'/>
                      <Input 
                      type="number"
                      placeholder='Price'
                      {...field}
                      className='p-regular-16 border-0 bg-grey-50 outline-offset-0 focus:border-0 focus-visible:ring-offset-0 focus-visible:ring-0'
                      />
